package com.academy.Lesson09Interface.HomeWork.TaskInterface.Lambda;

import com.academy.lesson5.oop.Date.CustomDate1;
import com.academy.lesson5.oop.Date.DateFormat;
import com.academy.lesson5.oop.Date.TimeFormat;
...
//¬алидаци€
    ...
    //а) —оздать перечисление "‘ормат времени" (TimeFormat), в котором определить следующие форматы:
    //		- H12		12 часовой			HH:MM:SS (am|pm)	09:23:45am, 09:23:45pm
    //		- H24		24 часовой			HH:MM:SS			09:23:45,	21:23:45
    //
    //	б)ћодифицировать класс CustomDateTime из пред. зан€ти€(ий), дл€ возможности отображени€ времени в заданном формате:
    //		- public String getFormattedDate() {} // возвращает дату и врем€ в формате по умолчанию: 24.01.2011	21:23:45
    //		- public String getFormattedDate(DateFormat dateFormat, TimeFormat format) {} // возвращает дату и врем€ в заданном форматах
